...
class WeightsSaver(Callback):
    ...
    def on_batch_end(self, batch, logs={}):
        if self.batch % self.N == 0:
            name = MODEL_SAVING_DIR + 'weights%08d.h5' % self.batch
...
print "max seq legnth : " + str(max_seq_length)
...
malstm_trained = malstm.fit([X_train['left'], X_train['right']], Y_train, batch_size=batch_size, nb_epoch=n_epoch,
                            validation_data=([X_validation['left'], X_validation['right']], Y_validation), callbacks=[WeightsSaver(malstm, 5)])
