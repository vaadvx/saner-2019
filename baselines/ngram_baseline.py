...
cpp_vectorizer = CountVectorizer(ngram_range=(3,3))
java_vectorizer =  CountVectorizer(ngram_range=(3,3))
...
print "shape of testing pairs : " + str(all_testing_pairs.shape)
...
print "precision : " + str(precision_score(test_labels, y_pred, average='micro'))
